 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.rentalmates.vivek.example.com", ownerName = "backend.rentalmates.vivek.example.com", packagePath = ""))
public class RegistrationEndpoint {
    ...
    public void registerDevice(@Named("regId") String regId) {
        ...
        log.info("Vivek: Registering device");
    ...
    public void unregisterDevice(@Named("regId") String regId) {
        ...
        log.info("Vivek: Unregistering device");
